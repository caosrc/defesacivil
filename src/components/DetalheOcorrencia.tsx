...
export default function DetalheOcorrencia({ ocorrencia: oc, onFechar, onDeletado, onAtualizado }: Props) {
  ...
  // Edit form state
  const [eTipo, setETipo] = useState(o.tipo)
  ...
  async function salvarEdicao() {
    if (!eTipo) { setErroEdit('Selecione o tipo.'); return }
    if (!eNatureza) { setErroEdit('Selecione a natureza.'); return }

    // Auto-geocode if address changed and no GPS
    let finalLat = eLat
    let finalLng = eLng
          ...
          {!editando ? (
            ...
            <>
              ...
              {o.fotos && o.fotos.length > 0 && (
                <div className="fotos-detalhe">
                  <div className="detalhe-label-row">🖼️ Fotos ({o.fotos.length})</div>
            ...
            <div className="edit-form">
              ...
              <div className="campo campo-edit">
                ...
                <select className="campo-select" value={eTipo} onChange={(e) => setETipo(e.target.value)}>
