...
- Aba Escala no menu inferior com calendário ADM, sobreaviso semanal, férias/folgas prolongadas e banco de horas; no calendário ADM aparecem bolinhas coloridas de todos os agentes ativos nos dias úteis, ocultando apenas quem estiver de folga ou férias, e em sábados, domingos e feriados aparecem apenas os agentes de sobreaviso da semana.
